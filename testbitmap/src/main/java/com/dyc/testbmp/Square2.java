...
public class Square2 {
    ...
    public Square2(Context context) {
        ...
        colorBuffer = ByteBuffer.allocateDirect(colorc.length*BYTES_PER_FLOAT).order(ByteOrder.nativeOrder()).asFloatBuffer();
        colorBuffer.put(colorc);
        colorBuffer.position(0);
        getProgram();

        uColorLocation = GLES20.glGetAttribLocation(program, U_COLOR);
        GLES20.glVertexAttribPointer(uColorLocation,4, GLES20.GL_FLOAT,false,0,colorBuffer);
